...
public class basketShadowDto { 
	...
	public basketShadowDto() {
		// TODO Auto-generated constructor stub
	}
	
	
	public basketShadowDto(int sdw_num, int bk_num, String mem_id, String hba_Id, int bk_amount, 
			String hba_info, int hba_price, String hba_img, int hba_stock,int hba_size,String rt_rentdate) {
		super();
		this.sdw_num =sdw_num;
		this.bk_num = bk_num;
		this.mem_id = mem_id;
		this.hba_Id = hba_Id;
	 ...
	 * @return the sdw_num
	 */
	public int getSdw_num() {
		return sdw_num;
	}


	/**
	 * @param sdw_num the sdw_num to set
	 */
	public void setSdw_num(int sdw_num) {
		this.sdw_num = sdw_num;
	}
